...
int main ( int argc, char **argv )
{
  ...
  // printf("Reading in command-line options\n");
    SM_Logs(LOG_INFO, _ARIA_, "CONFIGURATIONS LOADED SUCCESSFULLY");
  ...
  SM_Logs(LOG_INFO, _ARIA_, "PERFORMING RRU CONFIGURATIONS");
  ...
  SM_Logs(LOG_INFO,_ARIA_ ,"Critical system directive initiated: Primary operational threads deployment in progress. Awaiting all essential services to achieve operational readiness.");
  ...
  // printf("About to Init RU threads RC.nb_RU:%d\n", RC.nb_RU);
    SM_Logs(LOG_INFO, _F1AP_, "Commencing Radio Unit (RU) thread instantiation. RC.nb_RU:%d\n", RC.nb_RU);
  ...
  if (RC.nb_RU > 0 && NFAPI_MODE != NFAPI_MODE_VNF) {
    ...
    // printf("ALL RUs ready - init eNBs\n");
        SM_Logs(LOG_INFO, _ARIA_, "RADIO UNIT STATUS: \033[0;32mHealthy\033[0m");
