...
void loader_init(void) {
  ...
  loader_data.shlibpath = global_configs.loddt_shlibpath;

  // if (loader_data.shlibpath == NULL) {
  //   printf("shlibpath  in lI is NULL\n");
  // } else if (*loader_data.shlibpath == '\0') {
  //     printf("shlibpath  in lI is an empty string\n");
  // } else {
  //     printf("shlibpath in lI : %s\n", loader_data.shlibpath);
  // }
  loader_data.maxshlibs = global_configs.maxshlibs;
