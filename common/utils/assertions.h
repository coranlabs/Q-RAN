...
do {                                                         \
    if (!(cOND)) {                                           \
        fprintf(stderr, "\nCRITICAL ERROR, (%s) Aborting ARIA!\n", \
                #cOND);                                      \
        aCTION;                                              \
    }                                                        \
} while(0)
...
// #define _Assert_(cOND, aCTION, fORMAT, aRGS...)    ((void)0)
// #define AssertFatal(cOND, fORMAT, aRGS...)          ((void)0)
// #define AssertError(cOND, aCTION, fORMAT, aRGS...)  ((void)0)
