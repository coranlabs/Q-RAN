...
{
   // xer_fprint(stdout, &asn_DEF_NR_PUCCH_ConfigCommon, (void *)&pcc);
                                      ...
                                      const nr_mac_timers_t *timer_config)
{
  ...
  SM_Logs(LOG_INFO, _RRC_, "SIB1 Configuration: Frequency Offset from Reference Point A is set to %d",(int)sib1->servingCellConfigCommon->downlinkConfigCommon.frequencyInfoDL.offsetToPointA );
