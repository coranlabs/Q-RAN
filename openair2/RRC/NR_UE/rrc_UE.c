                                                 ...
                                                 const uint8_t buffer_len)
{
  ...
  if ((dec_rval.code != RC_OK) || (dec_rval.consumed == 0)) {
    ...
    SM_Logs(LOG_ERROR,_RRC_,"Failed to decode nr-bcch-bch");
    return;
  }
  if (LOG_DEBUGFLAG(DEBUG_ASN1))
                                                      ...
                                                      const uint8_t rsrp)
{
  ...
  if ((dec_rval.code != RC_OK) && (dec_rval.consumed == 0)) {
    ...
    SM_Logs(LOG_ERROR,_RRC_,"Failed to decode Bcch-DL-Sch");
                                    ...
                                    const NRRrcMacCcchDataInd *ind)
{
  ...
  if ((dec_rval.code != RC_OK) && (dec_rval.consumed == 0)) {
    ...
    SM_Logs(LOG_ERROR,_RRC_,"Failed to decode Dl-Ccch");
                                 ...
                                 const nr_pdcp_integrity_data_t *msg_integrity)
{
  ...
  if ((dec_rval.code != RC_OK) && (dec_rval.consumed == 0)) {
    ...
    SM_Logs(LOG_ERROR,_RRC_,"Failed to decode Dl-Dcch");
  ...
  switch (msg_type) {
    ...
    case NRUE_CAPABILITY_ENQUIRY: {
      ...
      if ((dec_rval.code != RC_OK) && (dec_rval.consumed == 0)) {
        ...
        SM_Logs(LOG_ERROR,_RRC_,"Failed to decode UE Capability info");
        break;
      }
