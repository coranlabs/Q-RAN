...
void handle_nr_rach(NR_UL_IND_t *UL_info)
{
  ...
  SM_Logs(LOG_ERROR,_MAC_,"Unsupported preamble count per Rach pdu");
      }
...
NR_IF_Module_t *NR_IF_Module_init(int Mod_id) {
  ...
  if (nr_if_inst[Mod_id]==NULL) {
    ...
    SM_Logs(LOG_INFO, _MAC_, "PARAMETERS ARE CONFIGURED. ASSIGNING SHARED STRUCTURES FOR COMMUNICATION BETWEEN LAYERS");
