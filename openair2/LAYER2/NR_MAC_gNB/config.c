                          ...
                          NR_ServingCellConfigCommon_t *scc)
{
  ...
  //       cfg->ssb_table.ssb_offset_point_a.value,
  //       cfg->ssb_table.ssb_subcarrier_offset.value);
    SM_Logs(LOG_INFO, _MAC_, "Other Metrics: ssb OffSetPointA: %d, ssb_SubCarrierOffest: %d",cfg->ssb_table.ssb_offset_point_a.value, cfg->ssb_table.ssb_subcarrier_offset.value);
  ...
  SM_Logs(LOG_INFO, _MAC_, "ANTENNA INFORMATION: RX NUMBER: %d, TX NUMBER: %d",cfg->carrier_config.num_tx_ant.value, cfg->carrier_config.num_rx_ant.value);
