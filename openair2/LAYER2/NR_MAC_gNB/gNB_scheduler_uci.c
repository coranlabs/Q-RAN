...
//       SM_Log_Assert(_MAC_,is_xlsch_in_slot(nrmac->ulsch_slot_bitmap[sched_slot / 64], sched_slot), "");
...
//           return tci->tci_StateId; // returned TCI state ID
//       } else{}
//       //  LOG_I(NR_MAC,"SSB index is not found in first 64 TCI states of TCI_statestoAddModList[%d]", i);
//     }
//   }
