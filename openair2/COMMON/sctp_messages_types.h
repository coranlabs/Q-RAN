...
enum sctp_state_e { SCTP_STATE_CLOSED, SCTP_STATE_SHUTDOWN, SCTP_STATE_ESTABLISHED, SCTP_STATE_UNREACHABLE };
...
// Just send the assoc id, the corresponding SSL object will be GRABBED FROM that.
typedef struct sctp_ssl_do_handshake {
  sctp_assoc_t assoc_id;
} sctp_ssl_do_handshake_t;
